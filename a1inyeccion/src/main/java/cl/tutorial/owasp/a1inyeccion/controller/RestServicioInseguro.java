 ...
 */
@RestController
@RequestMapping("/inseguro")
public class RestServicioInseguro extends RestAbstracto {

	public static final Logger LOGGER = LoggerFactory.getLogger(RestServicioInseguro.class);

	@Autowired
	private IUsuarioService usuarioServiceInseguro;
